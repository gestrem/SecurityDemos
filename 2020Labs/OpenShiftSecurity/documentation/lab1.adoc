...
. Create a new project called *myproject-userX*.
+
[source]
----
[localhost ~]$ oc new-project myproject-userX
----

. In the OpenShift console, navigate to *Home->Projects*, search for *myproject-userX* and click on it.
+
image:images/lab1.1-myproject-userX.png[]
...
. Now, go back to your terminal and go into the project you just created by typing *oc project myproject-userX*. Then, take a look at your pods by typing *oc get pods*. Notice that one of your pods has a CrashLoopBackOff error.
+
